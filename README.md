...
##### Pune / January 2015 – December 2017
...
### Hubnet web application (Meaningful collaboration — tangible results)
##### Tools/Technologies
- JavaScript, ES5, Angular2, jQuery, .Net MVC, .Net MVC Api, HTML, MS SQL
##### About Project
- As an all-inclusive workflow and collaboration platform, hubnet transforms the way you communicate with colleagues to complete everyday tasks, manage complex teams or find the right person for an important project. It whisks you away from the solitary — and often inadequate — tasks of syncing and sharing files and delivers you into a robust, social-centric hub where multiple users create, track, monitor, share, store, manage and collaborate on ideas, goals, projects and files
...
##### About Project
Meaningful collaboration — tangible results. Hubnetis can access and be in touch with
